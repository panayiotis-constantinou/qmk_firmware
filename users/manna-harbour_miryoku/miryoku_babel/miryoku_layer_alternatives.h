...
#define MIRYOKU_ALTERNATIVES_NAV \
    TD(U_TD_BOOT),         TD(U_TD_U_TAP),        TD(U_TD_U_EXTRA),      CW_TOGG,               U_NA,                  U_RDO,                 U_PST,                 U_CPY,                 U_CUT,                 U_UND, \
    KC_LGUI,               KC_LALT,               KC_LCTL,               KC_LSFT,               KC_CAPS,               CW_TOGG,               KC_LEFT,               KC_DOWN,               KC_UP,                 KC_RGHT, \
    KC_MCTL,               KC_ALGR,               TD(U_TD_U_NUM),        TD(U_TD_U_NAV),        U_NA,                  KC_INS,                KC_HOME,               KC_PGDN,               KC_PGUP,               KC_END, \
    U_NP,                  U_NP,                  U_NA,                  U_NA,                  U_NA,                  KC_ENT,                KC_BSPC,               KC_DEL,                U_NP,                  U_NP
...
#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FLIP \
    ...
    KC_WH_D,               KC_MS_L,               KC_MS_D,               MS_RGHT,               U_NU,                  U_NA,                  KC_LSFT,               KC_LCTL,               KC_LALT,               KC_LGUI, \
...
#define MIRYOKU_ALTERNATIVES_MOUSE_FLIP \
    ...
    KC_MS_L,               KC_MS_D,               KC_MS_U,               MS_RGHT,               U_NU,                  U_NA,                  KC_LSFT,               KC_LCTL,               KC_LALT,               KC_LGUI, \
    U_UND,                 U_CUT,                 U_CPY,                 U_PST,                 U_RDO,                 U_NA,                  TD(U_TD_U_MOUSE),      TD(U_TD_U_SYM),        KC_ALGR,               U_NA, \
    U_NP,                  U_NP,                  MS_BTN3,               MS_BTN1,               MS_BTN2,               U_NA,                  U_NA,                  U_NA,                  U_NP,                  U_NP
...
#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT \
    ...
    KC_LGUI,               KC_LALT,               KC_LCTL,               KC_LSFT,               U_NA,                  U_NU,                  KC_MS_L,               KC_MS_D,               MS_RGHT,               KC_WH_D, \
...
#define MIRYOKU_ALTERNATIVES_MOUSE_VI \
    TD(U_TD_BOOT),         TD(U_TD_U_TAP),        TD(U_TD_U_EXTRA),      TD(U_TD_U_BASE),       U_NA,                  U_RDO,                 U_PST,                 U_CPY,                 U_CUT,                 U_UND, \
    KC_LGUI,               KC_LALT,               KC_LCTL,               KC_LSFT,               U_NA,                  KC_MS_L,               KC_MS_D,               KC_MS_U,               MS_RGHT,               U_NU, \
...
#define MIRYOKU_ALTERNATIVES_MEDIA_FLIP \
    U_NA,                  RGB_HUI,               RGB_SAI,               U_NA,                  U_NA,                  U_NA,                  TD(U_TD_U_BASE),       TD(U_TD_U_EXTRA),      TD(U_TD_U_TAP),        TD(U_TD_BOOT), \
    KC_MPRV,               KC_VOLD,               KC_VOLU,               KC_MNXT,               U_NU,                  U_NA,                  KC_LSFT,               KC_LCTL,               KC_LALT,               KC_LGUI, \
    U_NU,                  U_NU,                  U_NU,                  U_NU,                  OU_AUTO,               U_NA,                  TD(U_TD_U_MEDIA),      TD(U_TD_U_FUN),        KC_ALGR,               U_NA, \
    U_NP,                  U_NP,                  KC_MUTE,               KC_MPLY,               KC_MSTP,               U_NA,                  U_NA,                  U_NA,                  U_NP,                  U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT \
    TD(U_TD_BOOT),         TD(U_TD_U_TAP),        TD(U_TD_U_EXTRA),      TD(U_TD_U_BASE),       U_NA,                  U_NA,                  U_NA,                  KC_VOLU,               RGB_HUI,               RGB_SAI, \
    KC_LGUI,               KC_LALT,               KC_LCTL,               KC_LSFT,               U_NA,                  U_NU,                  KC_MPRV,               KC_VOLD,               KC_MNXT,               U_NA, \
    U_NA,                  KC_ALGR,               TD(U_TD_U_FUN),        TD(U_TD_U_MEDIA),      U_NA,                  OU_AUTO,               U_NU,                  U_NU,                  U_NU,                  U_NU, \
    U_NP,                  U_NP,                  U_NA,                  U_NA,                  U_NA,                  KC_MSTP,               KC_MPLY,               KC_MUTE,               U_NP,                  U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_VI \
    TD(U_TD_BOOT),         TD(U_TD_U_TAP),        TD(U_TD_U_EXTRA),      TD(U_TD_U_BASE),       U_NA,                  U_NA,                  RGB_HUI,               RGB_SAI,               U_NA,                  U_NA, \
...
#define MIRYOKU_ALTERNATIVES_MEDIA \
    TD(U_TD_BOOT),         TD(U_TD_U_TAP),        TD(U_TD_U_EXTRA),      TD(U_TD_U_BASE),       U_NA,                  U_NA,                  U_NA,                  U_NA,                  U_NA,                  U_NA, \
...
#define MIRYOKU_ALTERNATIVES_NUM \
    KC_LBRC,               KC_7,                  KC_8,                  KC_9,                  KC_RBRC,               U_NA,                  KC_PLUS,               KC_MINS,               KC_ASTR,               KC_SLSH, \
